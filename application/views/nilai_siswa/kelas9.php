      ...
      <section id="main-content">
          <section class="wrapper">
                                  ...
                                  <div class="modal-dialog">
                                      <div class="modal-content col-md-12" style="width:133%;">
                                          ...
                                          <div class="modal-body">
                                              ...
                                              <form class="form-horizontal" role="form" method="post" action="<?php echo site_url('DNkelas9/post_UTS1')?>">
                                                  <div class="form-group ">
                                                    ...
                                                    <div class="col-lg-6">
                                                      ...
                                                      <?php foreach($nama as $n):?>
                                                          <option value="<?= $n->id_DS_kelas9 ?>"><?=$n->nama?></option>
                                                      <?php endforeach;?>
                                                      </select>
                                                    </div>
                                                  </div>
              ...
              <div class="row">
                  <div class="col-lg-12">
                      <section class="panel">
                          <header class="panel-heading" style="text-align: center; font-size:25px; padding:10px 0; background:#3499db; color:#ecf0f1;">
                              ...
                              foreach($record as $r):?>
                                <tr>
                                  ...
                                  <td><div class="btn-group">
                                            <a class="btn btn-danger" href="<?php echo site_url('DNkelas9/delete_UTS1/'. $r->id_DNUTS1_kelas9)?>"><i class="icon_close_alt2"></i></a>
                                            <a data-target="#myModal-2<?= $r->id_DNUTS1_kelas9 ?>" data-toggle="modal" class="btn btn-primary" >
                                            <i class="icon_plus_alt2" ></i>
                                            </a>

                                                    <div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-2" id="myModal-2<?= $r->id_DNUTS1_kelas9 ?>" class="modal fade">
                                                          <div class="modal-dialog">
                                                              <div class="modal-content col-md-12" style="width:133%;">
                                                                  <div class="modal-header">
                                                                      <button aria-hidden="true" data-dismiss="modal" class="close" type="button">×</button>
                                                                  ...
                                                                  <div class="modal-body">
                                                                      ...
                                                                      <form class="form-horizontal" role="form" method="post" action="<?php echo site_url('DNkelas9/edit_UTS1')?>"/>
                                                                      <input type="hidden" value="<?php echo $r->id_DNUTS1_kelas9 ?>" name="id">
                                                                    <div class="col-md-4">   
                                                                          <div class="form-group">
                                                                              <label for="cname" class="control-label col-lg-6">B. Indonesia <span class="required">*</span></label>
                                                                              <div class="col-lg-4">
                                  ...
                                  <div class="modal-dialog">
                                      <div class="modal-content col-md-12" style="width:133%;">
                                          ...
                                          <div class="modal-body">
                                              ...
                                              <form class="form-horizontal" role="form" method="post" action="<?php echo site_url('DNkelas9/post_SMT1')?>">
                                                  <div class="form-group ">
                                                    <label for="cname" class="control-label col-lg-2">Nama <span class="required">*</span></label>
                                                    <div class="col-lg-6">
                                                      <select class="form-control input-lg m-bot15" name="nama">
                            ...
                            <table class="table table-hover table-bordered table-striped table-advance">
                              ...
                              foreach($SMT1 as $r):?>
                                <tr>
                                  ...
                                  <td></td>
                                  <td><div class="btn-group">
                                            <a class="btn btn-danger" href="<?php echo site_url('DNkelas9/delete_SMT1/'. $r->id_DNSMT1_kelas9)?>"><i class="icon_close_alt2"></i></a>
                                            <a data-target="#myModal-4<?= $r->id_DNSMT1_kelas9 ?>" data-toggle="modal" class="btn btn-primary" >
                                            <i class="icon_plus_alt2" ></i>
                                            </a>

                                                    <div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-4" id="myModal-4<?= $r->id_DNSMT1_kelas9 ?>" class="modal fade">
                                                          <div class="modal-dialog">
                                                              <div class="modal-content col-md-12" style="width:133%;">
                                                                  <div class="modal-header">
                                                                      <button aria-hidden="true" data-dismiss="modal" class="close" type="button">×</button>
                                                                  ...
                                                                  <div class="modal-body">
                                                                      ...
                                                                      <form class="form-horizontal" role="form" method="post" action="<?php echo site_url('DNkelas9/edit_SMT1')?>"/>
                                                                      <input type="hidden" value="<?php echo $r->id_DNSMT1_kelas9 ?>" name="id">
                                                                    <div class="col-md-4">   
                                                                          <div class="form-group">
                                                                              <label for="cname" class="control-label col-lg-6">B. Indonesia <span class="required">*</span></label>
                                                                              <div class="col-lg-4">
                                  ...
                                  <div class="modal-dialog">
                                      <div class="modal-content col-md-12" style="width:133%;">
                                          ...
                                          <div class="modal-body">
                                              ...
                                              <form class="form-horizontal" role="form" method="post" action="<?php echo site_url('DNkelas9/post_UTS2')?>">
                                                  <div class="form-group ">
                                                    <label for="cname" class="control-label col-lg-2">Nama <span class="required">*</span></label>
                                                    <div class="col-lg-6">
                                                      <select class="form-control input-lg m-bot15" name="nama">
                            ...
                            <table class="table table-hover table-bordered table-striped table-advance">
                              ...
                              foreach($UTS2 as $r):?>
                                <tr>
                                  ...
                                  <td></td>
                                  <td><div class="btn-group">
                                            <a class="btn btn-danger" href="<?php echo site_url('DNkelas9/delete_UTS2/'. $r->id_DNUTS2_kelas9)?>"><i class="icon_close_alt2"></i></a>
                                            <a data-target="#myModal-6<?= $r->id_DNUTS2_kelas9 ?>" data-toggle="modal" class="btn btn-primary" >
                                            <i class="icon_plus_alt2" ></i>
                                            </a>

                                                    <div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-6" id="myModal-6<?= $r->id_DNUTS2_kelas9 ?>" class="modal fade">
                                                          <div class="modal-dialog">
                                                              <div class="modal-content col-md-12" style="width:133%;">
                                                                  <div class="modal-header">
                                                                      <button aria-hidden="true" data-dismiss="modal" class="close" type="button">×</button>
                                                                  ...
                                                                  <div class="modal-body">
                                                                      ...
                                                                      <form class="form-horizontal" role="form" method="post" action="<?php echo site_url('DNkelas9/edit_UTS2')?>"/>
                                                                      <input type="hidden" value="<?php echo $r->id_DNUTS2_kelas9 ?>" name="id">
                                                                    <div class="col-md-4">   
                                                                          <div class="form-group">
                                                                              <label for="cname" class="control-label col-lg-6">B. Indonesia <span class="required">*</span></label>
                                                                              <div class="col-lg-4">
              ...
              <section class="row">
                   <div class="panel-body">
                        <a href="#myModal-9" data-toggle="modal" class="btn btn-primary">
                                  Input Nilai Siswa Semester 2
                        </a>

                            <div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-9" id="myModal-9" class="modal fade">
                                  <div class="modal-dialog">
                                      <div class="modal-content col-md-12" style="width:133%;">
                                          <div class="modal-header">
                                              <button aria-hidden="true" data-dismiss="modal" class="close" type="button">×</button>
                                          ...
                                          <div class="modal-body">
                                              ...
                                              <form class="form-horizontal" role="form" method="post" action="<?php echo site_url('DNkelas9/post_SMT2')?>">
                                                  <div class="form-group ">
                                                    <label for="cname" class="control-label col-lg-2">Nama <span class="required">*</span></label>
                                                    <div class="col-lg-6">
                                                      <select class="form-control input-lg m-bot15" name="nama">
                            ...
                            <table class="table table-hover table-bordered table-striped table-advance">
                              ...
                              foreach($SMT2 as $r):?>
                                <tr>
                                  ...
                                  <td></td>
                                  <td><div class="btn-group">
                                            <a class="btn btn-danger" href="<?php echo site_url('DNkelas9/delete_SMT2/'. $r->id_DNSMT2_kelas9)?>"><i class="icon_close_alt2"></i></a>
                                            <a data-target="#myModal-9<?= $r->id_DNSMT2_kelas9 ?>" data-toggle="modal" class="btn btn-primary" >
                                            <i class="icon_plus_alt2" ></i>
                                            </a>

                                                    <div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-9" id="myModal-9<?= $r->id_DNSMT2_kelas9 ?>" class="modal fade">
                                                          <div class="modal-dialog">
                                                              <div class="modal-content col-md-12" style="width:133%;">
                                                                  <div class="modal-header">
                                                                      <button aria-hidden="true" data-dismiss="modal" class="close" type="button">×</button>
                                                                  ...
                                                                  <div class="modal-body">
                                                                      ...
                                                                      <form class="form-horizontal" role="form" method="post" action="<?php echo site_url('DNkelas9/edit_SMT2')?>"/>
                                                                      <input type="hidden" value="<?php echo $r->id_DNUTS12_kelas9 ?>" name="id">
                                                                    <div class="col-md-4">   
                                                                          <div class="form-group">
                                                                              <label for="cname" class="control-label col-lg-6">B. Indonesia <span class="required">*</span></label>
                                                                              <div class="col-lg-4">
