                                  ...
                                  <div class="modal-dialog">
                                      <div class="modal-content">
                                          ...
                                          <div class="modal-body">
                                              ...
                                              <form class="form-horizontal" role="form" method="post" action="<?php echo site_url('DSkelas8/post')?>">
                          ...
                          <table class="table table-striped table-advance table-hover">
                           <tbody>
                              ...
                              <tr>
                                 ...
                                 <td>
                                  <div class="btn-group">
                                            <a class="btn btn-danger" href="<?php echo site_url('DSkelas8/delete/'. $r->id_DS_kelas8)?>"><i class="icon_close_alt2"></i></a>
                                            <a data-target="#myModal-1<?= $r->id_DS_kelas8 ?>" data-toggle="modal" class="btn btn-primary" data-target="#myModal-1">
                                            <i class="icon_plus_alt2" ></i>
                                            </a>
                                              <div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="myModal-1<?= $r->id_DS_kelas8 ?>" class="modal fade">
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <button aria-hidden="true" data-dismiss="modal" class="close" type="button">×</button>
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <form class="form-horizontal" role="form" method="post" action="<?php echo site_url('DSkelas8/edit')?>">
                                                            <input type="hidden" value="<?php echo $r->id_DS_kelas8 ?>" name="id">
                                                                <div class="form-group ">
                                                                  <label for="cname" class="control-label col-lg-2">Nama <span class="required">*</span></label>
                                                                  <div class="col-lg-10">
