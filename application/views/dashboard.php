...
<html lang="en">
  ...
  <section id="container" class="">
      ...
      <header class="header dark-bg">
            ...
            <!--logo start-->
            <a href="index.html" class="logo">Admin <span class="lite">PIA</span></a>
            <!--logo end-->
          ...
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu">                
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                      	  <li><?php echo anchor('DSkelas7','Kelas 7')?></li>
                      	  <li><?php echo anchor('DSkelas8','Kelas 8')?></li>
                      	  <li><?php echo anchor('DSkelas9','Kelas 9')?></li>
                      </ul>
                  </li>
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          <li><a class="" href="DNkelas7.html">Kelas 7</a></li>
                          <li><a class="" href="DNkelas8.html">Kelas 8</a></li>
                          <li><a class="" href="DNkelas9.html">Kelas 9</a></li>
                      </ul>
                  </li>
                  ...
                  <li class="sub-menu">
                      <a href="javascript:;" class="">
                          ...
                          <span>Rekap Point</span>
                          <span class="menu-arrow arrow_carrot-right"></span>
                      </a>
                      <ul class="sub">
                          <li><a class="" href="general.html">Kelas 7</a></li>
                          <li><a class="" href="buttons.html">Kelas 8</a></li>
                          <li><a class="" href="grids.html">Kelas 9</a></li>
                      </ul>
                  </li>
                  <li>
